...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-100">
                ...
                <a class="text-3xl font-black" href="{{route('home')}}">
                    ...
                    @auth
                        ...
                        <nav class="flex gap-2 items-center"> 
                            {{-- Usuario autenticado --}}
                            <a class="flex font-bold items-center gap-2 bg-white border-lg  text-gray-600
                             text-sm uppercase cursor-pointer rounded"
                            ...
                            <a class="font-bold text-center text-gray-600 text-sm" href="{{ route('posts.index',auth()->user()->username) }}">
        ...
        <main class=" container mx-auto mt-10">
            <h2 class=" font-black text-center text-3xl mb10">@yield('titulo')</h2>
            @yield('contenido')
        </main>
